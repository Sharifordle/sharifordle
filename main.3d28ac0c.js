this.Sharifordle = this.Sharifordle || {}, this.Sharifordle.bundle = function(e) {
  "use strict";
  ...
  z.innerHTML = "\n  <slot></slot>\n";
  var j = "nyt-Sharifordle-darkmode",
      S = "nyt-Sharifordle-cbmode",
      C = function(e) {
          r(t, e);
          var a = h(t);
  ...
  var Ya = "nyt-Sharifordle-statistics",
      Ua = "fail",
      Ja = {
          currentStreak: 0,
          maxStreak: 0,
  ...
  var Ka, Qa = "nyt-Sharifordle-refresh",
      es = window.localStorage;

  function as() {
      return Ka || (Ka = setInterval((function() {
          es.getItem(Qa) && (es.removeItem(Qa), window.location.href.match(/.*\.nytimes\.com/g) ? window.location.reload(!0) : window.location.replace("https://www.nytimes.com/games/Sharifordle"))
      }), 432e5))
  }
  var ss = "nyt-Sharifordle-statistics",
          ...
          return n(t, [{
              ...
              value: function() {
                  if (6 === this.tileIndex && !(this.rowIndex >= 6)) {
                      ...
                      if (e = s, !Oa.includes(e) && !Ma.includes(e)) return a.setAttribute("invalid", ""), void this.addToast("That's not how you spell Sharif");
                      if (this.hardMode) {
              ...
              key: "addLetter",
              value: function(e) {
                  this.gameStatus === ls && (this.canInput && (this.tileIndex >= 6 || (this.boardState[this.rowIndex] += e, this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("letters", this.boardState[this.rowIndex]), this.tileIndex += 1)))
              }
          }, {
              key: "removeLetter",
              value: function() {
              ...
              value: function() {
                  if (this.gameStatus === ls && this.canInput) {
                      if (6 !== this.tileIndex) return this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("invalid", ""), void this.addToast("Sharif is 6 letters long, get it right.");
                      this.evaluateRow()
                  }
              }
          }, {
              ...
              value: function() {
                  ...
                  for (var c = 0; c < 6; c++) {
                      ...
                      u.setAttribute("letters", this.boardState[c]), u.setAttribute("length", 6), this.evaluations[c] && (u.evaluation = this.evaluations[c]), this.$board.appendChild(u)
                  }
  ...
  var Fs = document.createElement("template"),
      Ws = [{
          id: "spelling-bee",
          name: "Spelling Bee",
          url: "/puzzles/spelling-bee?utm_source=Sharifordle&utm_medium=referral&utm_campaign=Sharifordle_nav",
          backgroundImage: "var(--spelling-bee)"
      }, {
          id: "crossword",
          name: "The Crossword",
          url: "/crosswords/game/daily?utm_source=Sharifordle&utm_medium=referral&utm_campaign=Sharifordle_nav",
          backgroundImage: "var(--daily)"
      }, {
          id: "mini",
          name: "The Mini",
          url: "/crosswords/game/mini?utm_source=Sharifordle&utm_medium=referral&utm_campaign=Sharifordle_nav",
          backgroundImage: "var(--mini)"
      }, {
          id: "gameplay-stories",
          name: "Gameplay Stories",
          url: "/column/wordplay?utm_source=Sharifordle&utm_medium=referral&utm_campaign=Sharifordle_nav"
      }, {
          id: "more-games",
          name: "More Games",
          url: "/puzzles?utm_source=Sharifordle&utm_medium=referral&utm_campaign=Sharifordle_nav"
      }].map((function(e) {
      ...
      Ys = [{
          ...
          url: "https://www.nytimes.com/?utm_source=Sharifordle&utm_medium=referral&utm_campaign=Sharifordle_nav",
          ...
          url: "https://www.nytimes.com/wirecutter/?utm_source=Sharifordle&utm_medium=referral&utm_campaign=Sharifordle_nav",
          backgroundImage: "var(--wirecutter)"
      }, {
          id: "athletic",
          name: "The Athletic",
          url: "https://theathletic.com/?utm_source=Sharifordle&utm_medium=referral&utm_campaign=Sharifordle_nav",
  ...
  Qs.innerHTML = '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>Guess the <strong>Sharifordle</strong> in six tries.</p>\n      <p>Sharif sharif sharif sharif sharif sharif sharif sharif sharif sharif sharif</p>\n      <p>Sharif sharif sharif, sharif sharif sharif sharif sharif sharif sharif sharif! Sharif? Sharif Sharif ;).</p>\n      <div class="examples">\n        <p><strong>Examples</strong></p>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="s" evaluation="correct" reveal></game-tile>\n            <game-tile letter="h" evaluation="correct" reveal></game-tile>\n            <game-tile letter="a" evaluation="correct" reveal></game-tile>\n            <game-tile letter="r" evaluation="correct" reveal></game-tile>\n            <game-tile letter="i" evaluation="correct" reveal></game-tile>\n    <game-tile letter="f" evaluation="correct" reveal></game-tile>\n      </div>\n          <p>The letter <strong>SHARIF</strong> is in the Sharif and in the correct spot.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="s" evaluation="correct" reveal></game-tile>\n            <game-tile letter="h" evaluation="correct" reveal></game-tile>\n            <game-tile letter="a" evaluation="correct" reveal></game-tile>\n            <game-tile letter="r" evaluation="correct" reveal></game-tile>\n            <game-tile letter="i" evaluation="correct" reveal></game-tile>\n    <game-tile letter="f" evaluation="correct" reveal></game-tile>\n      </div>\n          <p>The letter <strong>SHARIF</strong> is Sharif.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n <game-tile letter="s" evaluation="correct" reveal></game-tile>\n           <game-tile letter="h" evaluation="correct" reveal></game-tile>\n           <game-tile letter="a" evaluation="correct" reveal></game-tile>\n           <game-tile letter="r" evaluation="correct" reveal></game-tile>\n            <game-tile letter="i" evaluation="correct" reveal></game-tile>\n            <game-tile letter="f" evaluation="correct" reveal></game-tile>\n          </div>\n          <p>The letter <strong>SHARIF</strong> is Sharif.</p>\n        </div>\n      </div>\n      <p><strong>A new Sharifordle will be available each day!<strong></p>\n    </div>\n  </section>\n';
  var et = function(e) {
      r(t, e);
      var a = h(t);
